...
```
Now this is a long and tedious process, and for several objects that are created in practical programs, this would not be feasible.  
Therefore, in order to solve this problem, **vectors** are used. 
